      ...
      <div className="hero-sec container d-flex p-0 py-5 justify-content-between">
        <div className="hero-content ">
          <h1 className="display-4 fw-bold ">
            Your <span className="span">partner</span> in <br /> keeping you <span className="span">healthy</span>
          </h1>
          <div className="gyr my-4">
            Get Your <strong className="mx-2">Reports</strong> in<span className="mx-2">12</span>hours
          </div>
        </div>
